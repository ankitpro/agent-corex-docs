...
description: 'Automate team collaboration workflows by seamlessly connecting Jira and Slack using Agent-CoreX MCP servers for intelligent issue management'
---
