...
description: 'Install, configure, and manage Model Context Protocol servers'
---
...
```bash
curl "https://app.agent-corex.com/mcp_servers" \
...
**Enable Server:**
```bash
curl -X POST "https://app.agent-corex.com/mcp_servers/toggle" \
  -H "Authorization: Bearer YOUR_API_KEY" \
...
```bash
curl "https://app.agent-corex.com/tools/installed" \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
```bash
curl "https://app.agent-corex.com/mcp_registry"
```
...
```bash
curl "https://app.agent-corex.com/mcp_registry/github-mcp"
```
...
```bash
curl -X POST "https://app.agent-corex.com/admin/mcp_registry" \
...
```bash
curl -X PATCH "https://app.agent-corex.com/admin/mcp_registry/github-mcp" \
  -H "Authorization: Bearer ADMIN_KEY" \
  -H "Content-Type: application/json" \
  -d '{
...
```bash
curl -X DELETE "https://app.agent-corex.com/admin/mcp_registry/github-mcp" \
  -H "Authorization: Bearer ADMIN_KEY"
```
...
```bash
curl -X POST "https://app.agent-corex.com/admin/mcp_registry/sync-to-supabase" \
  -H "Authorization: Bearer ADMIN_KEY"
```
