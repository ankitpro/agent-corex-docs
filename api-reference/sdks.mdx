---
title: 'SDK Examples'
description: 'Official and community SDKs for JavaScript, Python, and Go'
---
...
const client = new AgentCorex({
  apiKey: process.env.AGENT_COREX_API_KEY,
  baseUrl: 'https://app.agent-corex.com', // Custom endpoint
...
client = AgentCorex(
    ...
    base_url='https://app.agent-corex.com',  # Custom endpoint
    timeout=30,  # seconds
    max_retries=3,
    verify_ssl=True
)
