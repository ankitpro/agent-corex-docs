...
```bash
curl "https://app.agent-corex.com/webhooks" \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
```bash
curl -X PATCH "https://app.agent-corex.com/webhooks/hook_abc123" \
  -H "Authorization: Bearer YOUR_API_KEY" \
  -H "Content-Type: application/json" \
  -d '{
...
```bash
curl -X DELETE "https://app.agent-corex.com/webhooks/hook_abc123" \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
```bash
curl "https://app.agent-corex.com/webhooks/hook_abc123/deliveries" \
  -H "Authorization: Bearer YOUR_API_KEY"
```
