...
description: 'Create and manage custom MCP server packs with fine-grained control'
---
...
```bash
curl -X POST "https://app.agent-corex.com/custom-packs/mcp-servers" \
...
```bash
curl "https://app.agent-corex.com/custom-packs/mcp-servers" \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
```bash
curl -X POST "https://app.agent-corex.com/custom-packs/packs" \
  -H "Authorization: Bearer YOUR_API_KEY" \
  -H "Content-Type: application/json" \
  -d '{
...
```bash
curl "https://app.agent-corex.com/custom-packs/packs" \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
```bash
curl "https://app.agent-corex.com/custom-packs/packs/pack_dev_123" \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
```bash
curl -X PATCH "https://app.agent-corex.com/custom-packs/packs/pack_dev_123" \
  -H "Authorization: Bearer YOUR_API_KEY" \
  -H "Content-Type: application/json" \
  -d '{
...
```bash
curl -X DELETE "https://app.agent-corex.com/custom-packs/packs/pack_dev_123" \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
```bash
curl -X POST "https://app.agent-corex.com/custom-packs/packs/pack_dev_123/servers" \
  -H "Authorization: Bearer YOUR_API_KEY" \
  -H "Content-Type: application/json" \
  -d '{
    "server": "redis-mcp"
...
```bash
curl -X DELETE "https://app.agent-corex.com/custom-packs/packs/pack_dev_123/servers/redis-mcp" \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
```bash
curl -X PUT "https://app.agent-corex.com/custom-packs/packs/pack_dev_123/servers" \
  -H "Authorization: Bearer YOUR_API_KEY" \
  -H "Content-Type: application/json" \
  -d '{
...
```bash
curl "https://app.agent-corex.com/custom-packs/packs/pack_dev_123/install" \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
# Step 3: Enable it
curl -X POST "https://app.agent-corex.com/packs/enable" \
...
curl "https://app.agent-corex.com/retrieve_tools?query=create+github+issue" \
  -H "Authorization: Bearer YOUR_API_KEY"
