...
description: 'Complete reference for the /retrieve_tools API endpoint with semantic search, filtering options, detailed examples, and comprehensive error handling strategies'
---
