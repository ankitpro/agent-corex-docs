...
curl -H "Authorization: Bearer YOUR_API_KEY" \
  https://app.agent-corex.com/retrieve_tools?query=...
```

**Query Parameter**
```bash
curl "https://app.agent-corex.com/retrieve_tools?query=...&api_key=YOUR_API_KEY"
```
...
```bash
curl -X GET "https://app.agent-corex.com/v1/retrieve_tools" \
...
```bash
curl -X GET "https://app.agent-corex.com/v1/tools/create-pull-request" \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
```bash
curl -X POST "https://app.agent-corex.com/v1/execute_tool" \
  -H "Authorization: Bearer YOUR_API_KEY" \
  -H "Content-Type: application/json" \
  -d '{
...
```bash
curl "https://app.agent-corex.com/v1/tools?limit=10&offset=20"
```
...
```bash
curl "https://app.agent-corex.com/v1/retrieve_tools" \
  -d '{
    "query": "deploy",
    "filter": {
      "server": "aws-mcp",
...
```bash
curl -X POST "https://app.agent-corex.com/v1/webhooks" \
  -H "Authorization: Bearer YOUR_API_KEY" \
  -d '{
