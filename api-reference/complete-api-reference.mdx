...
curl -H "X-Admin-Key: ADMIN_KEY" \
  https://app.agent-corex.com/admin/users
```
...
<APIPlayground 
  ...
  baseUrl="https://app.agent-corex.com"
  auth={{
    type: "bearer",
    name: "API Key"
  }}
...
**Example Request:**
```bash
curl "https://app.agent-corex.com/v2/retrieve_tools?query=deploy&top_k=10&use_hybrid_v3=true" \
  -H "Authorization: Bearer YOUR_API_KEY"
```
