...
```bash
# ❌ Bad
curl "https://app.agent-corex.com/retrieve_tools"

# ✅ Good
curl "https://app.agent-corex.com/retrieve_tools?query=deploy"
```
...
# Or
curl "https://app.agent-corex.com/jobs?api_key=YOUR_API_KEY"
```
