...
description: 'Complete API reference for query event logging, tracking, and retrieval with dashboard integration for monitoring tool discovery and execution'
---
